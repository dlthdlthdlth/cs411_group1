...
CREATE TABLE RECOMMENDATIONS(
    ...
    LINK VARCHAR(350),
    IS_FREE VARCHAR(5),
    DATE_KEY VARCHAR(20) DEFAULT 'all',
    RADIUS VARCHAR(2) DEFAULT '',
    RNUM INT,
    PRIMARY KEY (RNUM),
    FOREIGN KEY (FBID) REFERENCES USER(FBID) ON DELETE CASCADE
);
...
ALTER TABLE RECOMMENDATIONS MODIFY NAME VARCHAR(150) CHARACTER SET utf8;
ALTER TABLE RECOMMENDATIONS MODIFY VENUE VARCHAR(100) CHARACTER SET utf8;
...
ALTER TABLE SAVEDEVENTS MODIFY NAME VARCHAR(150) CHARACTER SET utf8;
ALTER TABLE SAVEDEVENTS MODIFY VENUE VARCHAR(100) CHARACTER SET utf8;
